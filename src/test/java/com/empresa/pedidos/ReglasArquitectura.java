...
public class ReglasArquitectura {
    ...
    @ArchTest
    static final ArchRule controladoresSoloAccedenALaFacade = classes()
    ...
    @ArchTest
    static final ArchRule puertosDeDominioSonInterfaces = classes()
            .that().resideInAPackage("..dominio.puertos..")
            .should().beInterfaces();

    @ArchTest
    static final ArchRule procesadoresImplementanProcesadorPedido = classes()
            .that().resideInAPackage("..adaptadores.procesadores..")
            .should().implement(ProcesadorPedido.class);

    @ArchTest
    static final ArchRule infraestructuraNoAccedeAAdaptadoresRest = noClasses()
